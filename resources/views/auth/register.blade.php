...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .bg-particles{position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;opacity:0.06;background-image:radial-gradient(2px 2px at 20px 30px,#3b82f6,rgba(59,130,246,0)),radial-gradient(2px 2px at 60px 70px,#0ea5e9,rgba(14,165,233,0));background-repeat:repeat;background-size:200px 200px}
        ...
        input[type="text"],input[type="email"],input[type="password"]{width:100%;padding:12px 16px;border-radius:10px;border:1px solid rgba(59,130,246,0.3);background:rgba(15,23,42,0.8);color:#e2e8f0;font-size:14px;transition:all 0.2s ease}
        ...
        .login-link{font-size:13px;text-align:center;margin-top:20px;color:#94a3b8}
        .login-link a{color:var(--accent);text-decoration:none;font-weight:600;transition:color 0.2s}
