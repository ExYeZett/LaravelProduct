...
<div class="container">
    ...
    <form action="{{ route('products.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input id="name" type="text" name="name" placeholder="Nama Produk" required>
        </div>
        <div class="form-group">
            <label for="price">Harga Produk</label>
            <input id="price" type="number" name="price" placeholder="Harga Produk" required>
        </div>
        <div class="form-group">
            <label for="description">Deskripsi</label>
            <textarea id="description" name="description" placeholder="Deskripsi Produk" rows="4" required></textarea>
        </div>
            <div class="form-group">
                <label for="store">Store (pisahkan dengan koma)</label>
                <input id="store" type="text" name="store" placeholder="Toko Pusat, Toko Cabang Bandung" >
            </div>
            <div class="form-group">
                <label for="stock">Stock</label>
                <input id="stock" type="number" name="stock" value="0" min="0" placeholder="Jumlah stok" >
            </div>
